...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="sdbirth" class="form-control" id="txt_search_sdbirth1" >-
			      <input type="date" name="sdbirth" class="form-control" id="txt_search_sdbirth2" >
				</div>
			  </div>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>学生性别：</td>
								<td><input type="radio" id="sdsex1" name="sdsex" value="男"
	...
	<div class="modal fade" id="modal_user_addd" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addd" method="post" action="reserveaddd.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>专业名：</td>
								<td colspan="4">
